...
I'm an ML research scientist at the University of Toronto Mississauga, working under Dr. Jenny Cui on applied machine learning for public-safety and epidemiological decision-making. I graduated from UTM in 2026 with a BSc in Computer Science, Geospatial Data Science, and Mathematics. Separately, I contribute to the Medical Computer Vision and Robotics Lab on a diffusion-policy pipeline for surgical robotics.
